...
namespace ParticleSwarmOptimization.Examples
{
    ...
    {
        public static Swarm BealeFunction
            => Optimizer(Mozog.Examples.Functions.Beale, dimension: 2);

        public static Swarm GriewankFunction
            => Optimizer(Mozog.Examples.Functions.Griewank, dimension: 4);

        public static Swarm RosenbrockFunction
            => Optimizer(Mozog.Examples.Functions.Rosenbrock, dimension: 2);

        public static Swarm SphereFunction
            => Optimizer(Mozog.Examples.Functions.Sphere, dimension: 4);
