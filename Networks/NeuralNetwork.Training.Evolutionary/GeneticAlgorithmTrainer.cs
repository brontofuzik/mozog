...
namespace NeuralNetwork.Training.Evolutionary
{
    public class GeneticAlgorithmTrainer : TrainerBase<TrainingArgs>
    {
        ...
        {
            var networkAlgorithm = new GeneticAlgorithm<double>(network.SynapseCount).Configure(cfg => cfg
            ...
            var result = networkAlgorithm.Run(populationSize: 500, crossoverRate: 0.8, mutationRate: 0.05);
